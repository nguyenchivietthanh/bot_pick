...
Vendored unchanged from nguyenchivietthanh/bot_deli_ver1 (browser_fetch.py) — that
bot already solved Selenium/Chrome session handling against FMS in production;
no reason to rewrite it. Keep this file in sync with upstream if it changes.
